...
const EditEmployee = () => {
  ...
  useEffect(() => {
    const fetchEmployee = async () => {
      try {
        const response = await axios.get(`https://employee-backend-pearl-omega.vercel.app/api/employees/${id}`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(
        `https://employee-backend-pearl-omega.vercel.app/api/employees/${id}`,
        employee, {
        headers: {
          "Authorization": `Bearer ${localStorage.getItem("token")}`
        }
