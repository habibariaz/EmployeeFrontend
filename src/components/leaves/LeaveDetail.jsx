...
const LeaveDetail = () => {
    ...
    useEffect(() => {
        const fetchLeave = async () => {
            try {
                const response = await axios.get(`https://employee-backend-pearl-omega.vercel.app/api/leave/detail/${id}`, {
                    headers: {
    ...
    const changeStatus = async (id, status) => {
        try {
            const response = await axios.put(`https://employee-backend-pearl-omega.vercel.app/api/leave/${id}`, { status }, {
                headers: {
                    "Authorization": `Bearer ${localStorage.getItem("token")}`
                }
            })
